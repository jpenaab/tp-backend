...
<body style="background: none">
    ...
    <div class="col-md-6 offset-md-3">
        <div class="alert alert-danger alert-dismissible fade show" role="alert">
            <strong>Error!</strong> Ha habido algún error y la foto no se ha eliminado.
    ...
    <div class="col-md-6 offset-md-3">
        <div class="alert alert-success alert-dismissible fade show" role="alert">
            <strong>Eliminada!</strong> La fotografía ha sido eliminada correctamente.
            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                <span aria-hidden="true">&times;</span>
            </button>
        </div>
                ...
                <div class="col-lg-3 col-md-4 col-xs-6 thumb">
                    <figure class="figure">
                       <a class="thumbnail" href="#" data-image-id="" data-toggle="modal" data-title=""
                            ...
                            <img id="imgphoto" onclick="onClick(this,'${photo.getId()}')" src="/images/beaches/<fmt:formatNumber pattern="0000" value="${photo.getTPlayas().getId()}" />/${photo.getFilename()}" alt="${photo.getTPlayas().getNombre()}" class="rounded img-fluid">
                        </a>
                        <!--figure caption-->
                        <figcaption id="figcaptionimage${photo.getId()}" class="figure-caption text-center">
                            [${photo.getTUsuarios().getUsuario()}]
                            &nbsp;
                            ...
                            &nbsp;
                                <c:if test = "${photo.getEnabled() == 1}">
                                    ...
                                    <a href="/actionsphotos?opt=777&value=${photo.getId()}" title="deshabilitar" class="text-success"><i class="fas fa-check-circle"></i></a>

                                </c:if>
                                <c:if test = "${photo.getEnabled() == 0}">

                                    <a href="/actionsphotos?opt=888&value=${photo.getId()}" title="habilitar" class="text-danger"><i class="fas fa-times-circle"></i></a>

                                </c:if>
                                    &nbsp;
                            &nbsp;
                            <a href="/actionsphotos?opt=666&value=${photo.getId()}" title="eliminar"><i class="text-muted fas fa-trash-alt"></i></a>
                        </figcaption>
                    </figure>
                </div>
