...
<body style="background: none">
    ...
    <div class="col-md-6 offset-md-3">
        <div class="alert alert-danger alert-dismissible fade show" role="alert">
            <strong>Deshabilitada!</strong> La playa ha sido deshabilitada correctamente.
    ...
    <div class="col-md-6 offset-md-3">
        <div class="alert alert-success alert-dismissible fade show" role="alert">
            <strong>Habilitada!</strong> La playa ha sido habilitada correctamente.
            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                <span aria-hidden="true">&times;</span>
            </button>
        </div>
    ...
    <div class="col-md-6 offset-md-3">
        <div class="alert alert-danger alert-dismissible fade show" role="alert">
            <strong>Error!</strong> Ha habido algún error y la playa no se ha modificado.
            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                <span aria-hidden="true">&times;</span>
            </button>
        </div>
    ...
    <div class="col-md-6 offset-md-3">
        <div class="alert alert-success alert-dismissible fade show" role="alert">
            <strong>Guardada!</strong> La playa ha sido modificada correctamente.
            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                <span aria-hidden="true">&times;</span>
            </button>
        </div>
    ...
    <div class="col-md-6 offset-md-3">
        <div class="alert alert-danger alert-dismissible fade show" role="alert">
            <strong>Error!</strong> Ha habido algún error y la playa no se ha eliminado.
            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                <span aria-hidden="true">&times;</span>
            </button>
        </div>
    ...
    <div class="col-md-6 offset-md-3">
        <div class="alert alert-success alert-dismissible fade show" role="alert">
            <strong>Eliminada!</strong> La playa ha sido eliminado correctamente.
            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                <span aria-hidden="true">&times;</span>
            </button>
        </div>
                        ...
                        <tr class="text-dark">
                            ...
                            <td class="align-middle" >
                                <c:if test = "${enabled == 0}">
                                    ...
                                    <a href="/actionsplayas?opt=999&value=${playa.getId()}" title="habilitar" role="button" class="btn btn-outline-success btn-sm"><i class="fas fa-check-circle"></i></a>

                                </c:if>
                                <c:if test = "${enabled == 1}">

                                    <a href="/actionsplayas?opt=888&value=${playa.getId()}" title="deshabilitar" role="button" class="btn btn-outline-danger btn-sm"><i class="fas fa-times-circle"></i></a>

                                </c:if>

                                <button name="opt" value="777" title="guardar" type="submit" class="btn btn-outline-primary btn-sm"><i class="fas fa-save"></i></button>
                                <button name="opt" value="666" title="geolocalizar" type="submit" class="btn btn-outline-warning btn-sm"><i class="fas fa-map-marker-alt"></i></button>
                                ...
                                <button name="opt" value="111" title="eliminar" type="submit" class="btn btn-outline-secondary btn-sm"><i class="fas fa-trash-alt"></i></butto
